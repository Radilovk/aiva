 ...
 * Adaptive: foreground at 75% safe zone on 108dp canvas (per density),
...
/** 75% safe zone — larger square fill without 80% black-tile artifact on teardrop launchers. */
export const SAFE_ZONE_RATIO = 0.75;
