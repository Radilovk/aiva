/**
 * Privacy Policy string translations for KAYA.
...
export const PRIVACY_STRINGS = {
  ...
  en: {
    ...
    privacySec1Body:
      'KAYA ("the app", "we") is a personal voice assistant for task management. Your privacy is our top priority. This policy explains how we collect, use, and protect your information.',
    ...
    privacySec3Intro:
      'KAYA offers integration with Google Calendar. When you choose to connect your Google account:',
    privacySec3Li1:
    ...
    privacySec3Li2:
      '<strong>Purpose:</strong> We use this access solely to synchronise your tasks with your calendar — to read existing events (to avoid duplicate entries) and to create new events based on the tasks you set in KAYA.',
    privacySec3Li3:
      '<strong>Limited Use:</strong> KAYA\'s use and transfer of information received from Google APIs to any other application will adhere to the <a href="https://developers.google.com/terms/api-services-user-data-policy#additional_requirements_for_specific_api_scopes" target="_blank" style="color:var(--accent)">Google API Services User Data Policy</a>, including the Limited Use requirements.',
    privacySec3Li4:
  ...
  bg: {
    ...
    privacySec1Body:
      'KAYA ("приложението", "ние") е личен гласов асистент за управление на задачи. Вашата поверителност е наш основен приоритет. Тази декларация обяснява как събираме, използваме и защитаваме вашата информация.',
    ...
    privacySec3Intro:
      'KAYA предлага интеграция с Google Calendar. Когато изберете да свържете вашия Google акаунт:',
    privacySec3Li1:
    ...
    privacySec3Li2:
      '<strong>Цел:</strong> Използваме този достъп единствено за да синхронизираме вашите задачи с вашия календар – да четем съществуващи събития (за да не се дублират ангажименти) и да създаваме нови събития въз основа на задачите, които поставяте в KAYA.',
    privacySec3Li3:
      '<strong>Ограничена употреба (Limited Use):</strong> Използването и трансферът на информация, получена от API на Google, от страна на KAYA към всяко друго приложение, ще се придържа към <a href="https://developers.google.com/terms/api-services-user-data-policy#additional_requirements_for_specific_api_scopes" target="_blank" style="color:var(--accent)">Политиката за потребителски данни на услугите на Google API</a>, включително изискванията за ограничена употреба.',
    privacySec3Li4:
  ...
  zh: {
    ...
    privacySec1Body:
      'KAYA（"本应用"、"我们"）是一款用于任务管理的个人语音助手。您的隐私是我们的首要任务。本政策说明我们如何收集、使用和保护您的信息。',
    ...
    privacySec3Intro:
      'KAYA 提供与 Google 日历的集成。当您选择关联 Google 账户时：',
    privacySec3Li1:
      '<strong>访问权限：</strong>应用将请求读取和写入您的 Google 日历的权限（<code>https://www.googleapis.com/auth/calendar.events</code>）。',
    privacySec3Li2:
      '<strong>用途：</strong>我们仅将此访问权限用于将您的任务与日历同步——读取现有事件（以避免重复条目）以及根据您在 KAYA 中设置的任务创建新事件。',
    privacySec3Li3:
      '<strong>有限使用：</strong>KAYA 对从 Google API 获取的信息的使用和传输将遵守 <a href="https://developers.google.com/terms/api-services-user-data-policy#additional_requirements_for_specific_api_scopes" target="_blank" style="color:var(--accent)">Google API 服务用户数据政策</a>，包括有限使用要求。',
    privacySec3Li4:
  ...
  hi: {
    ...
    privacySec1Body:
      'KAYA ("ऐप", "हम") एक व्यक्तिगत वॉयस असिस्टेंट है जो कार्य प्रबंधन के लिए डिज़ाइन किया गया है। आपकी गोपनीयता हमारी सर्वोच्च प्राथमिकता है। यह नीति बताती है कि हम आपकी जानकारी कैसे एकत्र करते, उपयोग करते और सुरक्षित करते हैं।',
    ...
    privacySec3Intro:
      'KAYA Google Calendar के साथ एकीकरण प्रदान करता है। जब आप अपना Google खाता कनेक्ट करना चुनते हैं:',
    privacySec3Li1:
    ...
    privacySec3Li2:
      '<strong>उद्देश्य:</strong> हम इस पहुँच का उपयोग केवल आपके कार्यों को आपके कैलेंडर से सिंक्रनाइज़ करने के लिए करते हैं — मौजूदा इवेंट पढ़ने (डुप्लीकेट से बचने) और KAYA में सेट किए गए कार्यों के आधार पर नए इवेंट बनाने के लिए।',
    privacySec3Li3:
      '<strong>सीमित उपयोग:</strong> Google API से प्राप्त जानकारी का KAYA द्वारा उपयोग और हस्तांतरण <a href="https://developers.google.com/terms/api-services-user-data-policy#additional_requirements_for_specific_api_scopes" target="_blank" style="color:var(--accent)">Google API सेवाओं की उपयोगकर्ता डेटा नीति</a> का पालन करेगा, जिसमें सीमित उपयोग की आवश्यकताएँ शामिल हैं।',
    privacySec3Li4:
  ...
  es: {
    ...
    privacySec1Body:
      'KAYA ("la aplicación", "nosotros") es un asistente de voz personal para la gestión de tareas. Tu privacidad es nuestra máxima prioridad. Esta política explica cómo recopilamos, utilizamos y protegemos tu información.',
    ...
    privacySec3Intro:
      'KAYA ofrece integración con Google Calendar. Cuando eliges conectar tu cuenta de Google:',
    privacySec3Li1:
    ...
    privacySec3Li2:
      '<strong>Finalidad:</strong> Utilizamos este acceso únicamente para sincronizar tus tareas con tu calendario: leer eventos existentes (para evitar duplicados) y crear nuevos eventos basados en las tareas que estableces en KAYA.',
    privacySec3Li3:
      '<strong>Uso limitado:</strong> El uso y la transferencia de información obtenida de las API de Google por parte de KAYA a cualquier otra aplicación se ajustará a la <a href="https://developers.google.com/terms/api-services-user-data-policy#additional_requirements_for_specific_api_scopes" target="_blank" style="color:var(--accent)">Política de datos de usuario de los servicios de la API de Google</a>, incluidos los requisitos de uso limitado.',
    privacySec3Li4:
  ...
  fr: {
    ...
    privacySec1Body:
      'KAYA (« l\'application », « nous ») est un assistant vocal personnel dédié à la gestion des tâches. Votre confidentialité est notre priorité absolue. Cette politique explique comment nous collectons, utilisons et protégeons vos informations.',
    ...
    privacySec3Intro:
      'KAYA propose une intégration avec Google Agenda. Lorsque vous choisissez de connecter votre compte Google :',
    privacySec3Li1:
  ...
  de: {
    ...
    privacySec1Body:
      'KAYA („die App", „wir") ist ein persönlicher Sprachassistent zur Aufgabenverwaltung. Ihre Privatsphäre hat für uns höchste Priorität. Diese Erklärung erläutert, wie wir Ihre Daten erheben, verwenden und schützen.',
    ...
    privacySec3Intro:
      'KAYA bietet eine Integration mit Google Kalender an. Wenn Sie Ihr Google-Konto verknüpfen möchten:',
    privacySec3Li1:
    ...
    privacySec3Li2:
      '<strong>Zweck:</strong> Wir nutzen diesen Zugriff ausschließlich zur Synchronisierung Ihrer Aufgaben mit Ihrem Kalender — zum Lesen vorhandener Termine (zur Vermeidung von Duplikaten) und zum Erstellen neuer Einträge auf Basis der in KAYA gesetzten Aufgaben.',
    privacySec3Li3:
      '<strong>Eingeschränkte Nutzung:</strong> Die Verwendung und Weitergabe von Informationen, die KAYA über Google APIs erhält, an andere Anwendungen erfolgt in Übereinstimmung mit der <a href="https://developers.google.com/terms/api-services-user-data-policy#additional_requirements_for_specific_api_scopes" target="_blank" style="color:var(--accent)">Richtlinie für Nutzerdaten der Google API-Dienste</a>, einschließlich der Anforderungen zur eingeschränkten Nutzung.',
    privacySec3Li4:
  ...
  ru: {
    ...
    privacySec1Body:
      'KAYA («приложение», «мы») — персональный голосовой ассистент для управления задачами. Ваша конфиденциальность является нашим главным приоритетом. Настоящая политика объясняет, как мы собираем, используем и защищаем вашу информацию.',
    ...
    privacySec3Intro:
      'KAYA предлагает интеграцию с Google Календарём. Когда вы выбираете подключение аккаунта Google:',
    privacySec3Li1:
    ...
    privacySec3Li2:
      '<strong>Цель:</strong> Мы используем этот доступ исключительно для синхронизации ваших задач с календарём — чтения существующих событий (во избежание дублирования) и создания новых событий на основе задач, установленных в KAYA.',
    privacySec3Li3:
      '<strong>Ограниченное использование:</strong> Использование и передача информации, полученной от API Google, приложением KAYA любому другому приложению будут соответствовать <a href="https://developers.google.com/terms/api-services-user-data-policy#additional_requirements_for_specific_api_scopes" target="_blank" style="color:var(--accent)">Политике использования данных пользователей сервисов Google API</a>, включая требования об ограниченном использовании.',
    privacySec3Li4:
  ...
  ar: {
    ...
    privacySec1Body:
      'KAYA ("التطبيق"، "نحن") مساعد صوتي شخصي لإدارة المهام. تُعدّ خصوصيتك أولويتنا القصوى. توضح هذه السياسة كيفية جمعنا لمعلوماتك واستخدامها وحمايتها.',
    ...
    privacySec3Intro:
      'يوفر تطبيق KAYA تكاملاً مع Google Calendar. عند اختيارك ربط حساب Google الخاص بك:',
    privacySec3Li1:
