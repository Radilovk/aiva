/**
 * Internationalization for KASY — AI Secretary (9 languages).
 */
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      bargeIn: 'Voice interruption',
      bargeInHint: 'Interrupt the assistant while it speaks. Turn off if you get echo issues.',
      backHome: '← Home',
      ...
      morningBriefCalendarPrompt: 'Also mention briefly that there are {count} calendar event(s) today and ask if the user wants a quick rundown.',
    ...
    zh: {
      ...
      onboardingIntroTitle: '欢迎使用 KASY',
      onboardingIntroBody: 'KASY 是您的个人语音任务和日历助手。\n\n• 自然说话即可创建、编辑和完成任务\n• 与设备日历同步任务\n• 获取即将到来的提醒\n• 讨论任务并通过网络搜索获取建议',
      continue: '继续',
      getStarted: '开始使用',
      skip: '跳过',
      profile: '个人资料',
      ...
      bargeIn: '语音打断',
      bargeInHint: '助手说话时可以打断它。如有回声问题请关闭。',
      backHome: '← 首页',
      settingsTitle: '设置',
      save: '保存',
      reset: '重置',
    ...
    hi: {
      ...
      upcoming: 'आगामी',
      tapToRecord: 'आवाज़ के लिए टैप करें',
      ...
      bargeIn: 'आवाज़ से टोकना',
      bargeInHint: 'सहायक के बोलते समय उसे टोक सकते हैं। इको की समस्या होने पर बंद करें।',
      backHome: '← होम',
    ...
    es: {
      ...
      bargeIn: 'Interrupción por voz',
      bargeInHint: 'Interrumpe al asistente mientras habla. Desactívalo si hay problemas de eco.',
      backHome: '← Inicio',
    ...
    fr: {
      ...
      upcoming: 'À venir',
      tapToRecord: 'Appuyez pour la voix',
      listening: 'Écoute...',
      ...
      bargeIn: 'Interruption vocale',
      bargeInHint: "Interrompez l'assistant pendant qu'il parle. Désactivez en cas d'écho.",
      backHome: '← Accueil',
    ...
    de: {
      ...
      tapToRecord: 'Tippen für Sprache',
      listening: 'Höre zu...',
      connecting: 'Verbinde...',
      ...
      bargeIn: 'Sprachunterbrechung',
      bargeInHint: 'Unterbrich den Assistenten, während er spricht. Bei Echoproblemen ausschalten.',
      backHome: '← Start',
    ...
    ru: {
      ...
      tapToRecord: 'Нажмите для голоса',
      listening: 'Слушаю...',
      ...
      bargeIn: 'Прерывание голосом',
      bargeInHint: 'Можно перебивать ассистента, пока он говорит. Отключите при проблемах с эхом.',
      backHome: '← Главная',
    ...
    ar: {
      ...
      bargeIn: 'المقاطعة الصوتية',
      bargeInHint: 'يمكنك مقاطعة المساعد أثناء حديثه. أوقفه عند وجود صدى.',
      backHome: '← الرئيسية',
    ...
    bg: {
      ...
      bargeIn: 'Прекъсване с глас',
      bargeInHint: 'Можеш да прекъсваш асистента, докато говори. Изключи при проблеми с ехо.',
      backHome: '← Начало',
      settingsTitle: 'Настройки',
      save: 'Запази',
      reset: 'Нулирай',
      ...
      morningBriefCalendarPrompt: 'Спомени накратко, че има {count} събития в календара днес, и попитай дали да ги прегледаш накратко.',
