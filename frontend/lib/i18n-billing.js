...
(function () {
  const BILLING = {
    en: {
      ...
      paywallTitle: 'Upgrade to KASY Plus',
      paywallSessionLimit: 'You reached today\'s voice limit on the Free plan.',
      paywallCloudCal: 'Cloud calendar sync requires KASY Plus.',
      paywallTaskLimit: 'Active task limit reached. Upgrade for unlimited tasks.',
      paywallBrief: 'Daily AI brief is part of KASY Plus.',
      paywallGrounding: 'Web search in discussions requires KASY Plus.',
    ...
    bg: {
      ...
      paywallTitle: 'Надградете до KASY Plus',
      paywallSessionLimit: 'Достигнахте дневния лимит на безплатния план.',
      paywallCloudCal: 'Облачен календар изисква KASY Plus.',
      paywallTaskLimit: 'Лимит на активни задачи. Надградете за неограничени задачи.',
      paywallBrief: 'Дневният AI преглед е част от KASY Plus.',
